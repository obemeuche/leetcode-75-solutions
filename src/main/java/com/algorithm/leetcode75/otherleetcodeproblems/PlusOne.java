...
public class PlusOne {
    ...
    static int[] plusOne(int[] digits) {
        //iterate the digits array starting from the last index
        //if element is < 9, increase by 1, and return digits
        //else make the element = 0;
        //outside the loop, cater for an increment in the length of the array.
